...
var applyStardustTheme = function (themeName) {
    if (themeName === void 0) { themeName = stardust.options.theme; }
    if (stardust.themes.indexOf(themeName) < 0) {
        themeName = 'light';
    }
    stardust.selectedTheme = themeName;
    var styles = document.querySelectorAll('.stardust-theme-style');
...
var showModal = function (modalName) {
    var modal = document.querySelector("#" + modalName + "-wrap");
    if (modal) {
