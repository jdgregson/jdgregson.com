...
var initApp = function () {
    ...
    initStardust({
        'actions': {
            'showDemoModal': function () { showModal('demo'); },
            'toggleCheckbox': function () { console.log('toggle'); },
            'showToast': function () { showToast('This is a toast'); },
            'showLoadingBar': function () { loadingBarDemo(); }
        },
        'options': {
